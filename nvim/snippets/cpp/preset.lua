...
local aus = ls.extend_decorator.apply(ls.snippet, { hidden = true, wordTrig = false, snippetType = 'autosnippet', trigEngine = 'plain' }) -- plain autosnippet
local raus = ls.extend_decorator.apply(ls.snippet, { hidden = true, wordTrig = false, snippetType = 'autosnippet', trigEngine = 'pattern' }) -- regex autosnippet
