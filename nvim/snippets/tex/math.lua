...
local aus = ls.extend_decorator.apply(ls.snippet, { condition = in_math, hidden = true, wordTrig = false, snippetType = 'autosnippet', trigEngine = 'plain' }) -- plain autosnippet
local raus = ls.extend_decorator.apply(ls.snippet, { condition = in_math, hidden = true, wordTrig = false, snippetType = 'autosnippet', trigEngine = 'pattern' }) -- regex autosnippet
local maus = ls.extend_decorator.apply(ls.multi_snippet, { common = { condition = in_math, hidden = true, wordTrig = false, snippetType = 'autosnippet', trigEngine = 'plain'} }) -- plain multiautosnippet

local ams_aus = ls.extend_decorator.apply(ls.snippet, { condition = amath, hidden = true, wordTrig = false, snippetType = 'autosnippet', trigEngine = 'plain' }) -- plain amsmath autosnippet
local asymb_aus = ls.extend_decorator.apply(ls.snippet, { condition = asymb_cond, hidden = true, wordTrig = false, snippetType = 'autosnippet', trigEngine = 'plain' }) -- plain amssymb autosnippet
